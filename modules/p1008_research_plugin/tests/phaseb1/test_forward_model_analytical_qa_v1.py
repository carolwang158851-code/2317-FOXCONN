...
class ForwardModelAnalyticalQAV1Tests(unittest.TestCase):
    ...
    def test_qa34_full_history_count_unchanged(self):
        ...
        self.assertEqual(baseline["observation_count"], 147)
        periods = [item["period"] for item in baseline["observations"]]
        self.assertIn("2021Q1", periods)
        self.assertEqual(periods.count("2026Q2"), 15)
