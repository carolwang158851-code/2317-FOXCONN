    ...
    def _build_quarterly(
        ...
        *,
        ...
        sections = [
            ...
            self._section("RETIREMENT_CASHFLOW_IMPLICATION", "治理、企業價值與退休任務總結", "Q2營收、營業利益、歸母淨利、EPS與BVPS已由正式來源升格；2026H1 ROE 6.21%為官方未年化值。Q2沒有證明AI專屬營收占比或利潤率，Cloud & Networking 51%不得稱為AI占比；ROIC 16.46%因Net Cash定義與現金口徑未通過Owner Gate A，仍是條件式候選。2026H1 CFO與FCF為負，現金回收仍是主要驗證點。核心論點存續，但估值安全、退休現金流安全與股利能力都不因本季成長自動上修。", "INFERENCE", official_ids + [master_id, cash_id]),
