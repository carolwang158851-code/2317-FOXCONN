...
class AuthorityAdapter:
    ...
    CURRENT_BASELINE_VERSION = "P1008_AUTHORITY_2026-07-20_V1"
    ...
    CURRENT_AUTHORITY_PATHS = LEGACY_AUTHORITY_PATHS | {
    ...
    def __init__(self, package_root: Path | str, loader: ContractLoader) -> None:
        ...
        if (
            ...
            and self._safe_package_path("data/2317_cash_flow_authority.csv").exists()
        ):
            raise AuthorityAdapterError(
    ...
    def _expected_paths(cls, version: str) -> frozenset[str]:
        ...
        if version == cls.CURRENT_BASELINE_VERSION:
            return cls.CURRENT_AUTHORITY_PATHS
