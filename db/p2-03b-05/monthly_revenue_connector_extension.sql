-- P1008 P2-03B-05 staging-only monthly revenue connector extension.
...
CREATE TABLE monthly_revenue_rows (
    monthly_revenue_row_uid TEXT PRIMARY KEY CHECK(length(monthly_revenue_row_uid) = 26),
    ...
    data_year_month_roc TEXT NOT NULL,
    data_year_month TEXT NOT NULL,
...
CREATE TABLE monthly_revenue_facts (
    fact_uid TEXT PRIMARY KEY CHECK(length(fact_uid) = 26),
    monthly_revenue_row_uid TEXT NOT NULL REFERENCES monthly_revenue_rows(monthly_revenue_row_uid),
...
CREATE TABLE source_comparisons (
    ...
    fact_uid TEXT NOT NULL REFERENCES monthly_revenue_facts(fact_uid),
    comparison_code TEXT NOT NULL UNIQUE,
    source_value TEXT NOT NULL,
    existing_document_path TEXT NOT NULL,
